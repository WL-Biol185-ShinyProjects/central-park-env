...
squirrel_data <- read_csv("raw_data/2018_Central_Park_Squirrel_Census_-_Squirrel_Data_20260216.csv")
hectare_data <- read_csv("raw_data/2018_Central_Park_Squirrel_Census_-_Hectare_Data_20260216.csv")
story_data <- read_csv("raw_data/2018_Central_Park_Squirrel_Census_-_Stories_20260216 (1).csv")
